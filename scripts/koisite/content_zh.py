...
LANDING = {
    ...
    "sections": [
        DEMO,
        {
            ...
            "id": "input-methods",
            "index": "01",
            "heading": "五種輸入方式，同一個鍵盤",
            "lead": "不必為了轉換輸入法，而在系統鍵盤清單中反覆翻找。五種模式都在 KOI 之內，切換即時完成。",
            "points": [
        ...
        },
        {
            ...
            "index": "03",
            "heading": "需要時才存在的 AI",
            "lead": "六種模式全部在鍵盤上完成，不必跳出去其他 app。不開啟，它就完全不存在。",
            "points": [
        ...
        },
        {
            ...
            "tone": "quiet",
            "heading": "KOI Plus",
            "lead": "免費版本已經包含五種輸入法、手寫、學習與全部基本輸入功能。Plus 另加兩項，並附送每月 Credits。",
            "points": [
        ...
        },
        {
            ...
            "tone": "quiet",
            "heading": "開始使用",
            "lead": "KOI 需要 iOS 16.0 或以上。上架後，安裝只需要在 iOS 設定中加入鍵盤。",
            "points": [
                {"title": "完整取用", "body": "只有 AI 功能與剪貼簿貼上需要。不開啟的話，五種輸入法、候選字、學習與手寫全部照常運作。"},
    ...
    "sections": [
        ...
        },
        {
            ...
            "items": [
                ...
                {
                    "term": "完整取用權限",
                    "detail": "AI 功能與剪貼簿貼上需要開啟「允許完整取用」。不開啟的話，五種輸入法、候選字、學習與手寫全部照常運作。",
                },
                {
                    "term": "字元覆蓋",
